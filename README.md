...
Here is the live application: (https://financialchatbot01.streamlit.app/)
...
- Groq LLM for query understanding and explanations
- Automatic company/entity validation
- Statistical summary
...
Groq Explanation
↓
Streamlit Response + Visualization
